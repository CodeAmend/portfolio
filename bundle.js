...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _hero = __webpack_require__(214);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _skills_reducer = __webpack_require__(210);

	var _skills_reducer2 = _interopRequireDefault(_skills_reducer);

	var _commits_reducer = __webpack_require__(211);

	var _commits_reducer2 = _interopRequireDefault(_commits_reducer);

	var _project_reducer = __webpack_require__(213);

	var _project_reducer2 = _interopRequireDefault(_project_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({ skills: _skills_reducer2.default, commits: _commits_reducer2.default, projects: _project_reducer2.default });
...
/***/ (function(module, exports) {
	...
	var FETCH_COMMITS = exports.FETCH_COMMITS = 'FETCH_COMMITS';
...
/***/ (function(module, exports) {
	...
	exports.default = function () {
	  return [{
	    ...
	    tagline: 'React / Redux demo',
	    bullets: ['Put my React / Redux skills to the test', 'Custom API to display data', 'Sketches drawn on graph paper'],
	    skills: [{ name: 'Node.js' }, { name: 'React' }, { name: 'Express' }, { name: 'TDD' }, { name: 'API' }, { name: 'Semantic UI' }]
	  }, {
	    name: 'Schedule',
	    tagline: 'Electron React / Redux demo',
	    bullets: ['Put my React / Redux skills to the test', 'earned an amazing tool called Electron', 'Sketches drawn on graph paper'],
	    skills: [{ name: 'Electron' }, { name: 'React' }, { name: 'Bulma CSS' }, { name: 'Client' }, { name: 'Semantic UI' }]
	  }];
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _commits = __webpack_require__(215);
	...
	var Hero = function Hero() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'section',
	        { className: 'ui equal width stackable grid' },
	        _react2.default.createElement(
	          'article',
	          { className: 'column' },
	          _react2.default.createElement(
	            'nav',
	            { className: 'ui internally celled grid quad' },
	            _react2.default.createElement(
	              'section',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'p',
	                null,
	                'I have a strong interest to build booking systems, schedulars and social connection apps. Yeah! Stuff like that!'
	              ),
	              _react2.default.createElement(
	                'p',
	                null,
	              ...
	              _react2.default.createElement(
	                'p',
	                null,
	                'Here is what I am doing to get me to the next level.'
	              )
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'article',
	              { className: 'latest-course' },
	              _react2.default.createElement(
	                'h3',
	                null,
	                'Last Finished Course...'
	              ),
	              _react2.default.createElement(
	                'p',
	                null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Commits = function (_Component) {
	  ...
	  _createClass(Commits, [{
	    key: 'renderLatestGitCommits',
	    value: function renderLatestGitCommits(numberOfCommits) {
	      ...
	      return commits[0].map(function (commit) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'item' },
	          _react2.default.createElement('i', { className: 'large github middle aligned icon' }),
	          _react2.default.createElement(
	            'div',
	            { className: 'content' },
	            _react2.default.createElement(
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'article',
	        { className: 'latest-commits ui ralaxed divided list' },
	        _react2.default.createElement(
	          'h3',
	          null,
	          'Latest Git Commits'
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, { fetchCommits: _index.fetchCommits })(Commits);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function fetchCommits(numberOfCommits) {
	  ...
	  var request = _axios2.default.get('https://api.github.com/users/codeamend/repos?per_page=' + numberOfCommits, null, config);

	  return function (dispatch) {
	    request.then(function (handledRequest) {
	      dispatch({ type: _types.FETCH_COMMITS, payload: handledRequest.data });
	    });
	  };
	}
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5)))
	  ...
	  _createClass(Projects, [{
	    ...
	    value: function renderProjects() {
	      return this.props.projects.map(function (project) {
	        ...
	        function renderProjectBullets() {
	          return project.bullets.map(function (bullet) {
	            return _react2.default.createElement(
	              'div',
	              { className: 'item' },
	              bullet
	        ...
	        function renderProjectSkills() {
	          return project.skills.map(function (skill) {
	            return _react2.default.createElement(
	              'div',
	              { className: 'ui label' },
	              skill.name
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'image' },
	            _react2.default.createElement('img', { src: 'http://lorempixel.com/250/250/' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'content' },
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'ui container divided items' },
	          this.renderProjects()
	        )
	      );
	    }
	  ...
	  _createClass(Skills, [{
	    ...
	    value: function renderSkills() {
	      return this.props.skills.map(function (skill) {
	        return _react2.default.createElement(
	          'article',
	          { key: skill.title, className: 'ui centered card' },
	          _react2.default.createElement(
	            'section',
	            { className: 'content' },
	            _react2.default.createElement(
	              'a',
	              { href: '#', className: 'right floated meta' },
	              'projects: 5'
	            ),
	            _react2.default.createElement(
	              'h5',
	          ...
	          _react2.default.createElement(
	            ...
	            { className: 'extra' },
	            'Skill',
	            _react2.default.createElement('section', { className: 'ui heart rating', 'data-rating': skill.level })
	          )
	        );
	      });
	    }
